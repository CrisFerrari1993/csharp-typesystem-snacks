...
namespace csharp_typesystem_snacks
{
    internal class Program
    {
        ...
        {
            Console.WriteLine("Quale snack vuoi controllare? (1/10)");
            ...
            switch (caseSwitch)
            {
                ...
                case 8:
                    {
                        ...
                        Console.WriteLine($"La somma dei numeri con indice dispari inclusi nell'array è: {add}");
                        break;
                    }
                case 9:
                    {
                ...
                default: Console.WriteLine("Numero non valido"); break;
            }
        }
    }
}
